...
def run_pso(data_pres, sessions, w2v, sources, targets):
    ...
    xopt, fopt = pso(obj_func, lb, ub, data_pres, sessions, sources, w2v, sources, targets, swarmsize=swarmsize, maxiter=n_iter,
...
if __name__ == "__main__":
    ...
    run_pso(data_pres, sessions, w2v, sources, targets)
