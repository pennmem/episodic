...
def pso(func, lb, ub, data_pres, identifiers, w2v, sources, target_stats, swarmsize=100,
        ...
        c2_min=.5, c2_max=2.5, hard_bounds=False, maxiter=100, algorithm='pso', optfile=None):
    """
            ...
            for i in range(S):
                ...
                try:
                    ...
                    if not oob:
                        ...
                        err, stats = func(x[i, :], target_stats, data_pres, identifiers, w2v, sources)
...
def run_pso(data_pres, sessions, w2v, sources, targets, swarmsize, n_iter):
    ...
    #pso(func, lb, ub, data_pres, identifiers, w2v, sources, target_stats, swarmsize=100,
     #   omega_min=.8, omega_max=.8, d_omega=.1, c1=2, c2=2, c3=0.5, c4=0.5, R=1,
      #  c2_min=.5, c2_max=2.5, hard_bounds=False, maxiter=100, algorithm='pso', optfile=None)
...
if __name__ == "__main__":
    ...
    target_stat_file = basepath+'/data/eeg/scalp/ltp/ltpFR2/behavioral/stats/stats_LTP321.json'
    ...
    print ('Running PSO')
    #run_pso(data_pres, sessions, w2v, sources, targets, swarmsize, n_iter)
    try:
        run_pso(data_pres, sessions, w2v, sources, targets, 5, 5)
        ...
        f = open(basepath+'/home1/shai.goldman/pyCMR2/IRT_Optimizations/err_outfiles/err1.txt', 'w')
