...
def main():
    ...
    on_rhino = True
    if on_rhino:
        LSA_path = '/home1/rivkat.cohen/PycharmProjects/testing_Jul9/CMR2_lowmem/K02_LSA.txt'
    ...
    xopt, fopt = pso(obj_func, lb, ub, swarmsize=100, maxiter=100, debug=False)
