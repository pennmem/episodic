...
run_fr.m - Using a param structure as input, simulates sessions of free recall.
This code can be used to generate model predictions for Simulations 1,2,4 in
the manuscript. See Helper Files below for loading in the relevant parameters.
...
user must specify which data set to simulate. To simulate both data
sets, proceed as follows:
load DATAPATH/L13_data;
load L13_param;
data_efr = run_fr(param,data_efr);
data_ifr = run_fr(param,data_ifr);
L13_plot
